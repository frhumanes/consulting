...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('userprofile_profile', (
            ...
            ('first_surname', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('second_surname', self.gf('django.db.models.fields.CharField')(max_length=150)),
            ('dni', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('sex', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ...
            ('landline', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('mobilephone', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('profession', self.gf('django.db.models.fields.CharField')(max_length=150)),
