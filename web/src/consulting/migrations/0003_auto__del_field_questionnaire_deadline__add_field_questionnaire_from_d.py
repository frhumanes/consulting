...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Questionnaire.deadline'
        db.delete_column('consulting_questionnaire', 'deadline')

        # Adding field 'Questionnaire.from_date'
        db.add_column('consulting_questionnaire', 'from_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Questionnaire.to_date'
        db.add_column('consulting_questionnaire', 'to_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Changing field 'Questionnaire.creation_date'
        db.alter_column('consulting_questionnaire', 'creation_date', self.gf('django.db.models.fields.DateTimeField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Questionnaire.deadline'
        raise RuntimeError("Cannot reverse this migration. 'Questionnaire.deadline' and its values cannot be restored.")

        # Deleting field 'Questionnaire.from_date'
        db.delete_column('consulting_questionnaire', 'from_date')

        # Deleting field 'Questionnaire.to_date'
        db.delete_column('consulting_questionnaire', 'to_date')

        # User chose to not deal with backwards NULL issues for 'Questionnaire.creation_date'
        raise RuntimeError("Cannot reverse this migration. 'Questionnaire.creation_date' and its values cannot be restored.")
