...
class SlotAdmin(admin.ModelAdmin):
    list_display = ["creator", "slot_type", "weekday", "month", "year",
...
class AppointmentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_(u'Configuración'), {
            'fields': ('app_type', 'notify', 'duration',
...
class PaymentAdmin(admin.ModelAdmin):
    list_display = ["appointment", "value", "method", "date"]
    ...
    fieldsets = (
        ...
        (_(u'Pago'), {
            'fields': ("method", "date", ("value", "discount"))
        }),
        (_(u'Registro'), {
            'classes': ('collapse',),
            'fields': ('created_by', 'created_at', 'updated_at')
